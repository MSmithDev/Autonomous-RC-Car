  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Scott K Logan <logans@cottsay.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/install/${idir}'.  Ask the maintainer 'Scott K Logan <logans@cottsay.net>' to fix it.")
    endif()
    _list_append_unique(vesc_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "vesc_ros")
...
set(vesc_driver_EXPORTED_TARGETS "vesc_driver_gencfg")
...
set(depends "diagnostic_updater;dynamic_reconfigure;hardware_interface;roscpp;std_srvs")
